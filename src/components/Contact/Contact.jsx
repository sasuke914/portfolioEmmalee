          ...
          <div className="col-lg-6">
            ...
            <form action='' method="POST" className="st-contact-form" id="contact-form">
              <div className="st-form-field">
                <input type="text" id="name" name="name" onChange={handleChange} placeholder="Your Name" required />
              </div>
              <div className="st-form-field">
                <input type="text" id="email" name="email" onChange={handleChange} placeholder="Your Email" required />
              </div>
              <div className="st-form-field">
                <input type="text" id="subject" name="subject" onChange={handleChange} placeholder="Your Subject" required />
              </div>
              <div className="st-form-field">
                <textarea cols="30" rows="10" id="msg" name="msg" onChange={handleChange} placeholder="Your Message" required></textarea>
              </div>
              <button className='st-btn st-style1 st-color1' onClick={sendEmail} id="submit" name="submit">Send Message</button>
            </form>
            ...
            <div className="st-contact-info-wrap">
              <div className="st-single-contact-info">
                ...
                <div className="st-single-info-details">
                  <h4>Email</h4>
                  <Link >swiftcodex0325@outlook.com</Link>
